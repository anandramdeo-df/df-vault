...
- You can choose among 7 different controller which you want to show.
...
- You can choose any of the above viewController type and it will show the respected screen.
...
For viewController type “organizationUploadAssetRrequestList” you need to use DFDocument framework to capture the document which user want to upload. 

When user click on upload button you will get the data related to that organisation, which contains key value pairs.
Know you need to open the capture screen from DFDocument framework to capture the document and upload it on server by using API framework.
For more details go to this link :-  https://github.com/anandramdeo-df/df-documents
